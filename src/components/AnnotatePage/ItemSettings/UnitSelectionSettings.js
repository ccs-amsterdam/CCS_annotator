...
const UnitSelectionSettings = ({ totalItems, unitSelection, setItemSettings }) => {
  ...
  return (
    <Form>
      ...
      <Form.Group grouped>
        ...
        <Checkbox
          disabled={!unitSelection || unitSelection.value !== "per annotation"}
          label="highlight annotation"
          checked={unitSelection.highlightAnnotation}
          onChange={(e, d) =>
            setItemSettings((current) => ({
              ...current,
              unitSelection: {
                ...current.unitSelection,
                highlightAnnotation: d.checked,
              },
            }))
          }
...
export default UnitSelectionSettings;
